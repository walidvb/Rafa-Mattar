...
export const WithPointer = ({ children, className = '', onClick, pointerTitle, within = true }: { children: ReactNode; onClick?: () => void, className?: string, pointerTitle: string | ReactNode; within?: boolean }) => {
